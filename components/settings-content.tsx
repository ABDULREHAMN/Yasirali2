          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="name" placeholder="Enter your full name" defaultValue="Yasir Ali" />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  defaultValue="yasirali876gt@gmail.com"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="username">Username</Label>
                <Input id="username" placeholder="Enter your username" defaultValue="yasirali009" />
              </div>
              <div className="space-y-2">
